          ...
          >
            ...
            >
              <Image 
                ...
                priority // Membantu LCP (Largest Contentful Paint) lebih cepat
              />
            </motion.div>
            ...
            >
              {/* Diubah ke h1 karena ini teks utama yang muncul pertama kali saat dokumen dimuat */}
          ...
          >
            ...
            >
              <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-8 md:p-12 rounded-[3rem] shadow-2xl text-center">
                ...
                >
                   <Image src="/logo.svg" alt="SocialHub Main Logo" fill className="object-contain" />
                </motion.div>

                {/* Diubah menjadi h2 agar strukturnya runtut setelah h1 di splash screen */}
