...
export default function StoryViewerPage() {
  ...
  // Format waktu upload (relative time)
  ...
  // Navigasi ke dashboard dengan aman
  ...
  // 1. Ambil SEMUA Story Aktif milik User ini
  useEffect(() => {
  ...
  // Update viewer count, like status, upload time when current story changes
  useEffect(() => {
  ...
  // 2. Logic Mencatat Viewer (Hanya untuk story yang sedang aktif di layar)
  useEffect(() => {
    const markAsViewed = async () => {
      ...
      // Jangan catat viewer jika user melihat story sendiri
  ...
  // Balas Story dengan pesan lengkap
      ...
      >
        ...
        >
          <div className="modal-header">
            <h3>Penonton ({viewers.length})</h3>
            <button onClick={() => setShowViewers(false)} className="modal-close">
              ×
            </button>
          </div>
  ...
  const LikesModal = () => {
    ...
    return (
      ...
      >
        ...
        >
          <div className="modal-header">
            <h3>Like ({likes.length})</h3>
            <button onClick={() => setShowLikes(false)} className="modal-close">
              ×
            </button>
          </div>
          <div className="modal-list">
  ...
  return (
    <div className="story-viewer-container">
      ...
      <div className="top-overlay">
        ...
        <div className="user-info">
          ...
          <div className="action-buttons">
            ...
            <button onClick={navigateToDashboard} className="close-button">
              ×
            </button>
          </div>
        </div>
      ...
      {/* NAVIGATION AREA (TAP KIRI/KANAN) */}
      ...
      <div className="media-content">
        ...
        {/* Like Button Floating - Hanya untuk user lain */}
        {!isOwnStory && (
      ...
      {/* FOOTER: Reply Input (Hanya untuk story user lain) */}
      {!isOwnStory && (
      ...
      {/* Story Info Footer untuk story sendiri */}
      {isOwnStory && (
      ...
      <style jsx>{`
        ...
        @media (hover: hover) {
          .icon-button:hover, .reply-submit:hover, .floating-like:hover {
            opacity: 0.8;
          }
        }
      `}</style>
